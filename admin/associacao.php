...
// Pesquisa do Aluno
    $query_aluno = mysqli_query($conn,"SELECT * FROM usuario WHERE id_usuario=$id_usuario");
    $query_aluno = mysqli_fetch_array($query_aluno);
// 
...
?>
    ...
    <center>
    <h1 class="mb-3 font-weight-normal"> Associação do Aluno </h1>
    <h2 class="mb-3 font-weight-normal"><?php echo $query_aluno["nome"];?></h2>  

    <div class="container">
      <div style="background-color: #F5F5F5; width: 350px;border-style: solid; border-width: thin; border-color: #C0C0C0;"><br/>

          <form action="associar.php" method="POST">
