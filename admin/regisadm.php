<?php include 'cabecalhodash.php';?>
    ...
    <center>
    <h1 class="mb-3 font-weight-normal"> Cadastro de Administrador </h1><br/><!-- <hr style="border-color: #C0C0C0;" /> --><br/>  
    <div class="container">
      <div style="background-color: #F5F5F5; width: 350px;border-style: solid; border-width: thin; border-color: #C0C0C0;"><br/>
          <form action="incluir.php" method="POST">
            ...
            <button style="width: 300px;" name="tipo" value="adm" class="btn btn-md btn-primary btn-block" type="submit"><b><i class="fas fa-user-plus"></i> Cadastrar</b></button>
          </form><br/>
      </div>
    </div>
    </center>
