...
if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM associacao_professor WHERE id_usuario = $id_avaliador")) >= 1){
    ...
    if(mysqli_num_rows(mysqli_query($conn, "SELECT id_associacao FROM inscricao_inicial WHERE id_associacao = $id_associacao")) < 1){
        ...
        <center>
        <h1 class="mb-3 font-weight-normal"> Inscrição para Avaliação Inicial </h1><br/> 
        <div class="container">
            <div style="background-color: #F5F5F5; width: 350px;border-style: solid; border-width: thin; border-color: #C0C0C0;"><br/>
                <form action="processa_inscricao_inicial.php" method="POST">
                    ...
                    <button style="width: 300px;" name="id_associacao" value="<?php echo $id_associacao ?>" class="btn btn-md btn-primary btn-block" type="submit"><b>Inscrever-se</b></button>
    ...
    ?>
        <center>
        <br>
        <h1 class="mb-3 font-weight-normal text-secondary"> Você já está inscrito na avaliação inicial </h1><br/> 
...
?>
        ...
        <center>
        <br>
        <h1 class="mb-3 font-weight-normal text-secondary"> Apenas professores podem participar da avaliação inicial </h1><br/> 
        <a href="perfil_avaliador.php" style="width: 300px;" class="btn btn-md btn-outline-primary btn-block"><b>Voltar</b></a>
        </center>
