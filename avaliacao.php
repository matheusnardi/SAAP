...
<!--     <p class="mb-3 font-weight-normal"><b>Autores:</b> <?php echo $autores; ?> </p> -->
    ...
    <center> <button style="width: 100%;" name="tipo" value="comum" class="btn btn-lg btn-primary btn-block" type="submit"><b><i class="fas fa-check"></i> Enviar Avaliação</b></button> </center>
